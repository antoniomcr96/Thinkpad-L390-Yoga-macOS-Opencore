...
#define VOODOO_INPUT_BUTTON_COUNT_KEY "Button Count"
#define VOODOO_INPUT_RESOLUTION_KEY "Resolution"
#define VOODOO_INPUT_SCROLL_RESOLUTION_KEY "Scroll Resolution"
